export const heroData = {
  ...
  description: "Specializing in microfrontend architecture and scalable UI systems. Shipped production features across Angular and React. Enjoy owning problems end-to-end and building things that are fast, maintainable, and well-structured.",
  links: {
...
export const aboutData = {
  description: "I am a passionate software engineer focused on building robust and scalable frontend architectures. With a strong foundation in modern web technologies, I love delving into microfrontends, AI integrations, and crafting seamless user experiences.",
  education: {
  ...
  skills: [
    { category: "Core", items: ["C++", "TypeScript", "JavaScript", "Microfrontends", "Python"] },
    { category: "Frontend", items: ["Angular", "React.js"] },
    { category: "Platform & API", items: ["REST APIs", "Node.js services", "FastAPI"] },
    { category: "AI & Tools", items: ["Gemini API", "Agno", "Firebase", "Supabase", "MongoDB"] }
  ]
};
...
export const projectsData: ProjectData[] = [
  {
    ...
    description: "A modern, full-featured AI-first social profile management platform. Socially empowers users to generate and manage professional profiles, social links, analytics, resumes, and bento grids with an intuitive and responsive interface.",
    ...
    image: "https://github.com/user-attachments/assets/cd882a06-185f-4543-895a-96e080f3adaf",
    readmeUrl: "https://raw.githubusercontent.com/smil-thakur/Socially/main/README.md"
  },
  {
    title: "DailyFlow",
    tech: ["React 18+", "TypeScript", "Supabase", "Tailwind CSS"],
    duration: "Jul 2024 – Sep 2024",
    description: "Built a real-time collaborative calendar and schedule management app for teams with Supabase auth (magic link or OTP), invite-only onboarding, and live schedule syncing with distinct accessible colors for dynamic metrics.",
    github: "https://github.com/smil-thakur/DailyFlow",
    link: "https://github.com/smil-thakur/DailyFlow",
    image: "https://raw.githubusercontent.com/smil-thakur/DailyFlow/main/public/demo.png",
    readmeUrl: "https://raw.githubusercontent.com/smil-thakur/DailyFlow/main/README.md"
  },
  {
